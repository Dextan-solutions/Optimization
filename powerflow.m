...
DistLoadFlowSolution.VSI=vsi;
DistLoadFlowSolution.VSIsorted=VSIsorted;
DistLoadFlowSolution.minVSI=minvsi;

DistLoadFlowSolution.VSF=VSF;
DistLoadFlowSolution.VSFsum=VSFsum;
DistLoadFlowSolution.VDI=VDI;
DistLoadFlowSolution.VDIsum=VDIsum;
